          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-5 pt-4">
              ...
              <div className="flex items-center gap-2 px-6 py-4 bg-blue-400/30 backdrop-blur-md rounded-[1.5rem] border border-blue-300/40">
                ...
                <span className="font-black text-2xl">{profile?.points}</span>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 card-premium p-10">
          <div className="flex items-center justify-between mb-10">
            ...
            <Link to="/ejercicios" className="group px-6 py-3 bg-slate-50 text-slate-600 font-bold rounded-2xl hover:bg-blue-600 hover:text-white transition-all flex items-center gap-2">
              Ver ejercicios <ChevronRight className="w-4 h-4" />
            </Link>
          </div>
            ...
            {exams.length > 0 ? exams.map((exam) => (
              <div key={exam.id} className="flex items-center justify-between p-5 rounded-[2rem] bg-slate-50 border border-slate-100 hover:scale-[1.02] transition-all">
                ...
                <div className="text-right">
                  <p className="text-sm font-black text-slate-700">{Math.floor(exam.time_spent_seconds / 60)}m {exam.time_spent_seconds % 60}s</p>
                  <p className="text-[10px] uppercase font-black text-emerald-600">Simulacro</p>
                </div>
              </div>
            )) : (
